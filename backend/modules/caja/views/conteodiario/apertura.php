    ...
    <div class="clavepresupuestal-form fondo">
        ...
        <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-xs-7">
                    <?= $form->field($model, 'inal1',['showLabels'=>false])->textInput(['placeholder'=>'Monedas de 10 cents', 'class'=> 'calc']); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-3">
                ...
                <div class="col-xs-7">
                    <?= $form->field($model, 'inal2',['showLabels'=>false])->textInput(['placeholder'=>'Monedas de 20 cents', 'class'=> 'calc']); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-3">
        ...
        <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-xs-7">
                    <?= $form->field($model, 'iext1',['showLabels'=>false])->textInput(['placeholder'=>'Dolares']); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-7">
                    <?= $form->field($model, 'iext2',['showLabels'=>false])->textInput(['placeholder'=>'Euros']); ?>
                </div>
            </div>
        ...
        <div class="form-group kv-fieldset-inline">
            <div class="form-group">
                <?= Html::submitButton($model->isNewRecord ? 'Apertura' : 'Cierre', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
            </div>
