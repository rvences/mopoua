...
/**
 * TipoproveedoresSearch represents the model behind the search form about `backend\modules\mrp\models\Tipoproveedores`.
 */
class TipoproveedoresSearch extends Tipoproveedores
{
    /**
     * @inheritdoc
     */
